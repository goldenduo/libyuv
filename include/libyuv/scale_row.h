...
#if !defined(LIBYUV_DISABLE_RVV) && defined(__riscv_vector) && defined(__riscv_zve64x)
...
#if !defined(LIBYUV_DISABLE_RVV) && defined(__riscv_vector) && defined(__riscv_v_intrinsic) &&  __riscv_v_intrinsic == 11000
