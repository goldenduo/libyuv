...
#if defined(__riscv_v_intrinsic) &&  __riscv_v_intrinsic >= 12000 && !defined(LIBYUV_DISABLE_RVV)
...
#if !defined(LIBYUV_DISABLE_RVV) && defined(__riscv_vector) && !defined(LIBYUV_RVV_HAS_TUPLE_TYPE)
