...
// caveat: clangcl uses row_win.cc which works.
    ...
    defined(_MSC_VER)) && !defined(LIBYUV_ENABLE_ROWWIN)
// TODO(fbarchard): fix build error on android_full_debug=1
// https://code.google.com/p/libyuv/issues/detail?id=517
#define HAS_I422ALPHATOARGBROW_SSSE3
#define HAS_I444ALPHATOARGBROW_SSSE3
#endif
#if ((defined(__x86_64__) && !defined(LIBYUV_ENABLE_ROWWIN)) || !defined(__pic__) || defined(__clang__) || \
    defined(_MSC_VER)) && !defined(LIBYUV_ENABLE_ROWWIN)
// TODO(fbarchard): fix build error on android_full_debug=1
// https://code.google.com/p/libyuv/issues/detail?id=517
...
// TODO: port rowwin to use 8 bit coefficients.
...
// TODO(fbarchard): Port to Visual C
    ...
    (defined(CLANG_HAS_AVX2) || defined(GCC_HAS_AVX2)) && !defined(LIBYUV_ENABLE_ROWWIN)
...
#if !defined(LIBYUV_DISABLE_X86) && \
    (defined(__x86_64__) || defined(__i386__)) && defined(CLANG_HAS_AVX512) && !defined(LIBYUV_ENABLE_ROWWIN)
