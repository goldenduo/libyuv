...
#if !defined(LIBYUV_DISABLE_X86) && (defined(__i386__) || defined(__x86_64__)) && !defined(LIBYUV_ENABLE_ROWWIN)
#define HAS_TRANSPOSEWX8_SSSE3
...
#if !defined(LIBYUV_DISABLE_X86) && defined(__x86_64__) && !defined(LIBYUV_ENABLE_ROWWIN)
