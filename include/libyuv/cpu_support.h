...
#if defined(__clang__) && !defined(LIBYUV_ENABLE_ROWWIN) && (defined(__x86_64__) || defined(__i386__))
...
#if defined(_M_IX86) && (!defined(__clang__) || defined(LIBYUV_ENABLE_ROWWIN)) && defined(_MSC_VER) && \
    _MSC_VER >= 1700
