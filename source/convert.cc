...
static int I4xxToI420(const uint8_t* src_y,
  ...
  int r;
  if (!src_y || !src_u || !src_v || !dst_u || !dst_v ||
...
int I420Copy(const uint8_t* src_y,
  ...
  if (!src_y || !src_u || !src_v || !dst_u || !dst_v || width <= 0 || height == 0) {
    return -1;
  }
...
int I422ToNV21(const uint8_t* src_y,
  ...
  int halfwidth = (width + 1) >> 1;
  int halfheight = (height + 1) >> 1;
  if (!src_y || !src_u || !src_v || !dst_vu || width <= 0 || height == 0) {
    return -1;
  }
  // Negative height means invert the image.
  if (height < 0) {
...
int I400ToI420(const uint8_t* src_y,
  ...
  int halfwidth = (width + 1) >> 1;
  int halfheight = (height + 1) >> 1;
  if (!src_y || !dst_u || !dst_v || width <= 0 || height == 0) {
    return -1;
  }
  // Negative height means invert the image.
  if (height < 0) {
...
int I400ToNV21(const uint8_t* src_y,
  ...
  int halfwidth = (width + 1) >> 1;
  int halfheight = (height + 1) >> 1;
  if (!src_y || !dst_vu || width <= 0 || height == 0) {
    return -1;
  }
  // Negative height means invert the image.
  if (height < 0) {
...
int NV12ToI420(const uint8_t* src_y,
  ...
  int halfwidth = (width + 1) >> 1;
  int halfheight = (height + 1) >> 1;
  if (!src_y || !src_uv || !dst_u || !dst_v || width <= 0 || height == 0) {
    return -1;
  }
  // Negative height means invert the image.
  if (height < 0) {
