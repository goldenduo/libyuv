...
TEST_F(LibYUVConvertTest, TestI400LargeSize) {
  ...
  // - kWidth * kHeight * 4 > INT_MAX: This ensures that we check for integer
  //   overflows in the ANY* macro.
  // - kWidth * kHeight * 4 < UINT_MAX: This ensures that the product will fit
  //   size_t even on 32-bit systems.
